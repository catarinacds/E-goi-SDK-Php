...
class PingApi
{
     ...
     * @return \org.egoi.client\org.egoi.client.model\Ping|\org.egoi.client\org.egoi.client.model\InternalServerError
     */
     ...
     * @throws \org.egoi.client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \org.egoi.client\org.egoi.client.model\Ping|\org.egoi.client\org.egoi.client.model\InternalServerError, HTTP status code, HTTP response headers (array of strings)
     */
    public function pingWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\org.egoi.client\org.egoi.client.model\Ping' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\org.egoi.client\org.egoi.client.model\Ping', []),
            ...
            $returnType = '\org.egoi.client\org.egoi.client.model\Ping';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\org.egoi.client\org.egoi.client.model\Ping',
