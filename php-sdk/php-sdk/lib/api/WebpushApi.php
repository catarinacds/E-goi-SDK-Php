...
class WebpushApi
{
     ...
     *
     * @param  string $campaign_hash ID of the Campaign (required)
     * @param  \org.egoi.client\org.egoi.client.model\CampaignWebPushSendRequest $campaign_web_push_send_request Parameters for the &#39;send web-push&#39; action (required)
     *
     * @throws \org.egoi.client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \org.egoi.client\org.egoi.client.model\AcceptedResponse|\org.egoi.client\org.egoi.client.model\BadRequest|\org.egoi.client\org.egoi.client.model\Unauthorized|\org.egoi.client\org.egoi.client.model\Forbidden|\org.egoi.client\org.egoi.client.model\UnprocessableEntity|\org.egoi.client\org.egoi.client.model\InternalServerError
     ...
     *
     * @param  \org.egoi.client\org.egoi.client.model\WebPushCampaign $web_push_campaign Parameters for the webpush campaign (required)
     *
     * @throws \org.egoi.client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \org.egoi.client\org.egoi.client.model\WebPushRssCampaign $web_push_rss_campaign Parameters for the WebPush Campaign (required)
     *
     * @throws \org.egoi.client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \org.egoi.client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \org.egoi.client\org.egoi.client.model\TagCollection1|\org.egoi.client\org.egoi.client.model\Unauthorized|\org.egoi.client\org.egoi.client.model\Forbidden|\org.egoi.client\org.egoi.client.model\UnprocessableEntity|\org.egoi.client\org.egoi.client.model\InternalServerError
     */
     ...
     * @throws \org.egoi.client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \org.egoi.client\org.egoi.client.model\TagCollection1|\org.egoi.client\org.egoi.client.model\Unauthorized|\org.egoi.client\org.egoi.client.model\Forbidden|\org.egoi.client\org.egoi.client.model\UnprocessableEntity|\org.egoi.client\org.egoi.client.model\InternalServerError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAllWebPushSitesWithHttpInfo($offset = null, $limit = 10, $order = 'desc', $order_by = 'list_id', $list_id = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\org.egoi.client\org.egoi.client.model\TagCollection1' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\org.egoi.client\org.egoi.client.model\TagCollection1', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\org.egoi.client\org.egoi.client.model\TagCollection1';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\org.egoi.client\org.egoi.client.model\TagCollection1',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $campaign_hash ID of the Campaign (required)
     * @param  \org.egoi.client\org.egoi.client.model\WebPushPatchCampaign $web_push_patch_campaign Parameters for the Webpush Campaign (required)
     *
     * @throws \org.egoi.client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \org.egoi.client\org.egoi.client.model\CampaignHash|\org.egoi.client\org.egoi.client.model\BadRequest|\org.egoi.client\org.egoi.client.model\Unauthorized|\org.egoi.client\org.egoi.client.model\Forbidden|\org.egoi.client\org.egoi.client.model\NotFound|\org.egoi.client\org.egoi.client.model\UnprocessableEntity|\org.egoi.client\org.egoi.client.model\InternalServerError
