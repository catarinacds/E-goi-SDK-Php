...
class ContactsApi
{
    ...
    public function actionAttachTagWithHttpInfo($list_id, $attach_tag_request)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\org.egoi.client\org.egoi.client.model\AttachTagResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\org.egoi.client\org.egoi.client.model\AttachTagResponse', []),
            ...
            $returnType = '\org.egoi.client\org.egoi.client.model\AttachTagResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\org.egoi.client\org.egoi.client.model\AttachTagResponse',
     ...
     *
     * @param  int $list_id ID of the List (required)
     * @param  \org.egoi.client\org.egoi.client.model\ContactExportRequest $contact_export_request Parameters for export (required)
     *
     * @throws \org.egoi.client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  int $list_id ID of the List (required)
     * @param  \org.egoi.client\org.egoi.client.model\ImportBulkRequest $import_bulk_request Parameters for the bulk import (required)
     *
     * @throws \org.egoi.client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \org.egoi.client\org.egoi.client.model\ImportBulkResponse|\org.egoi.client\org.egoi.client.model\BadRequest|\org.egoi.client\org.egoi.client.model\Unauthorized|\org.egoi.client\org.egoi.client.model\Forbidden|\org.egoi.client\org.egoi.client.model\UnprocessableEntity|\org.egoi.client\org.egoi.client.model\InternalServerError
     */
    ...
    public function actionImportBulkWithHttpInfo($list_id, $import_bulk_request)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\org.egoi.client\org.egoi.client.model\ImportBulkResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\org.egoi.client\org.egoi.client.model\ImportBulkResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\org.egoi.client\org.egoi.client.model\ImportBulkResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\org.egoi.client\org.egoi.client.model\ImportBulkResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int $list_id ID of the List (required)
     * @param  \org.egoi.client\org.egoi.client.model\StartAutomationRequest $start_automation_request Parameters for the operation to start automation (required)
     *
     * @throws \org.egoi.client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function actionStartAutomationWithHttpInfo($list_id, $start_automation_request)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\org.egoi.client\org.egoi.client.model\StartAutomationResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\org.egoi.client\org.egoi.client.model\StartAutomationResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\org.egoi.client\org.egoi.client.model\StartAutomationResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\org.egoi.client\org.egoi.client.model\StartAutomationResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int $list_id ID of the List (required)
     * @param  \org.egoi.client\org.egoi.client.model\RemoveRequest $remove_request Parameters for the contact to unsubscribe (required)
     *
     * @throws \org.egoi.client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \org.egoi.client\org.egoi.client.model\RemoveResponse|\org.egoi.client\org.egoi.client.model\BadRequest|\org.egoi.client\org.egoi.client.model\Unauthorized|\org.egoi.client\org.egoi.client.model\Forbidden|\org.egoi.client\org.egoi.client.model\UnprocessableEntity|\org.egoi.client\org.egoi.client.model\InternalServerError
    ...
    public function actionUnsubscribeContactWithHttpInfo($list_id, $remove_request)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\org.egoi.client\org.egoi.client.model\RemoveResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\org.egoi.client\org.egoi.client.model\RemoveResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\org.egoi.client\org.egoi.client.model\RemoveResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\org.egoi.client\org.egoi.client.model\RemoveResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \org.egoi.client\org.egoi.client.model\ContactBaseExtra $contact_base_extra Parameters for the Contact (required)
     *
     * @throws \org.egoi.client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \org.egoi.client\org.egoi.client.model\CreateContactResponse|\org.egoi.client\org.egoi.client.model\BadRequest|\org.egoi.client\org.egoi.client.model\Unauthorized|\org.egoi.client\org.egoi.client.model\Forbidden|\org.egoi.client\org.egoi.client.model\NotFound|\org.egoi.client\org.egoi.client.model\PostContactsConflict|\org.egoi.client\org.egoi.client.model\UnprocessableEntity|\org.egoi.client\org.egoi.client.model\InternalServerError
     */
    ...
    public function createContactWithHttpInfo($list_id, $contact_base_extra)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\org.egoi.client\org.egoi.client.model\CreateContactResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\org.egoi.client\org.egoi.client.model\CreateContactResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                ...
                case 409:
                    if ('\org.egoi.client\org.egoi.client.model\PostContactsConflict' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\org.egoi.client\org.egoi.client.model\PostContactsConflict', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 422:
            ...
            $returnType = '\org.egoi.client\org.egoi.client.model\CreateContactResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\org.egoi.client\org.egoi.client.model\CreateContactResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                ...
                case 409:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\org.egoi.client\org.egoi.client.model\PostContactsConflict',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \org.egoi.client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \org.egoi.client\org.egoi.client.model\ActivityCollection|\org.egoi.client\org.egoi.client.model\Unauthorized|\org.egoi.client\org.egoi.client.model\Forbidden|\org.egoi.client\org.egoi.client.model\UnprocessableEntity|\org.egoi.client\org.egoi.client.model\InternalServerError
     */
     ...
     * @throws \org.egoi.client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \org.egoi.client\org.egoi.client.model\ActivityCollection|\org.egoi.client\org.egoi.client.model\Unauthorized|\org.egoi.client\org.egoi.client.model\Forbidden|\org.egoi.client\org.egoi.client.model\UnprocessableEntity|\org.egoi.client\org.egoi.client.model\InternalServerError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAllContactActivitiesWithHttpInfo($contact_id, $list_id, $offset = null, $limit = 10, $date_min = null, $date_max = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\org.egoi.client\org.egoi.client.model\ActivityCollection' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\org.egoi.client\org.egoi.client.model\ActivityCollection', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\org.egoi.client\org.egoi.client.model\ActivityCollection';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\org.egoi.client\org.egoi.client.model\ActivityCollection',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \org.egoi.client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \org.egoi.client\org.egoi.client.model\ContactCollection|\org.egoi.client\org.egoi.client.model\Unauthorized|\org.egoi.client\org.egoi.client.model\Forbidden|\org.egoi.client\org.egoi.client.model\NotFound|\org.egoi.client\org.egoi.client.model\UnprocessableEntity|\org.egoi.client\org.egoi.client.model\InternalServerError
     */
    ...
    public function getAllContactsWithHttpInfo($list_id, $offset = null, $limit = 10)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\org.egoi.client\org.egoi.client.model\ContactCollection' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\org.egoi.client\org.egoi.client.model\ContactCollection', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\org.egoi.client\org.egoi.client.model\ContactCollection';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\org.egoi.client\org.egoi.client.model\ContactCollection',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \org.egoi.client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \org.egoi.client\org.egoi.client.model\ComplexContact|\org.egoi.client\org.egoi.client.model\Unauthorized|\org.egoi.client\org.egoi.client.model\Forbidden|\org.egoi.client\org.egoi.client.model\NotFound|\org.egoi.client\org.egoi.client.model\UnprocessableEntity|\org.egoi.client\org.egoi.client.model\InternalServerError
     */
    ...
    public function getContactWithHttpInfo($contact_id, $list_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\org.egoi.client\org.egoi.client.model\ComplexContact' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\org.egoi.client\org.egoi.client.model\ComplexContact', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\org.egoi.client\org.egoi.client.model\ComplexContact';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\org.egoi.client\org.egoi.client.model\ComplexContact',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $contact_id ID of the Contact (required)
     * @param  int $list_id ID of the List (required)
     * @param  \org.egoi.client\org.egoi.client.model\ContactBaseStatusExtra $contact_base_status_extra Parameters for the contact (required)
     *
     * @throws \org.egoi.client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \org.egoi.client\org.egoi.client.model\CreateContactResponse|\org.egoi.client\org.egoi.client.model\BadRequest|\org.egoi.client\org.egoi.client.model\Unauthorized|\org.egoi.client\org.egoi.client.model\Forbidden|\org.egoi.client\org.egoi.client.model\NotFound|\org.egoi.client\org.egoi.client.model\UnprocessableEntity|\org.egoi.client\org.egoi.client.model\InternalServerError
