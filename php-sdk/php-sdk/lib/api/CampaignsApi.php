...
class CampaignsApi
{
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                case 409:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\org.egoi.client\org.egoi.client.model\DeleteCampaignsConflict',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \org.egoi.client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \org.egoi.client\org.egoi.client.model\CampaignsCollection|\org.egoi.client\org.egoi.client.model\Unauthorized|\org.egoi.client\org.egoi.client.model\Forbidden|\org.egoi.client\org.egoi.client.model\UnprocessableEntity|\org.egoi.client\org.egoi.client.model\InternalServerError
     */
    ...
    public function getAllCampaignsWithHttpInfo($channel = null, $campaign_hash = null, $list_id = null, $status = null, $internal_name = null, $created_by = null, $group_id = null, $created_min = null, $created_max = null, $updated_min = null, $updated_max = null, $start_date_min = null, $start_date_max = null, $end_date_min = null, $end_date_max = null, $schedule_date_min = null, $schedule_date_max = null, $offset = null, $limit = 10, $order = 'desc', $order_by = 'created')
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\org.egoi.client\org.egoi.client.model\CampaignsCollection' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\org.egoi.client\org.egoi.client.model\CampaignsCollection', []),
            ...
            $returnType = '\org.egoi.client\org.egoi.client.model\CampaignsCollection';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\org.egoi.client\org.egoi.client.model\CampaignsCollection',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
