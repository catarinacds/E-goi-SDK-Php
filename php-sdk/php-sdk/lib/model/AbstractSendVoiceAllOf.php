...
/**
 * AbstractSendVoiceAllOf Class Doc Comment
 *
 * @category Class
 * @package  org.egoi.client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AbstractSendVoiceAllOf implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AbstractSendVoice_allOf';
     ...
     *
     * @param string|null $destination_field Destination field of this campaign
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getDestinationFieldAllowableValues();
        if (!is_null($destination_field) && !in_array($destination_field, $allowedValues, true)) {
