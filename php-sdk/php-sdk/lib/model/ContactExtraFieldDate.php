...
/**
 * ContactExtraFieldDate Class Doc Comment
 *
 * @category Class
 * @package  org.egoi.client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ContactExtraFieldDate implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContactExtraFieldDate';
    ...
    public function setFieldId($field_id)
    {
        ...
        if (!is_null($field_id) && ($field_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $field_id when calling ContactExtraFieldDate., must be bigger than or equal to 1.');
        }
     ...
     * Sets value
     *
     * @param \DateTime|null $value Extra field value
     *
     * @return $this
     */
