...
/**
 * RequestItemsUnsubscribeAllOf Class Doc Comment
 *
 * @category Class
 * @package  org.egoi.client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class RequestItemsUnsubscribeAllOf implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RequestItemsUnsubscribe_allOf';
    ...
    public function setContactId($contact_id)
    {
        ...
        if (!is_null($contact_id) && (!preg_match("/[a-fA-F\\d]{10}/", $contact_id))) {
            throw new \InvalidArgumentException("invalid value for $contact_id when calling RequestItemsUnsubscribeAllOf., must conform to the pattern /[a-fA-F\\d]{10}/.");
        }
