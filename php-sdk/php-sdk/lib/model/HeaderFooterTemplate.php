...
/**
 * HeaderFooterTemplate Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class HeaderFooterTemplate implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HeaderFooterTemplate';
    ...
    public function setTemplateId($template_id)
    {
        ...
        if (!is_null($template_id) && ($template_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $template_id when calling HeaderFooterTemplate., must be bigger than or equal to 1.');
        }
     ...
     * Sets internal_name
     *
     * @param string|null $internal_name Internal name of the template
     *
     * @return $this
     */
     ...
     * Sets custom
     *
     * @param bool|null $custom True if this is a template created by some user
     *
     * @return $this
     */
