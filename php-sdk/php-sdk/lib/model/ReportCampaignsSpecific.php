...
/**
 * ReportCampaignsSpecific Class Doc Comment
 *
 * @category Class
 * @package  org.egoi.client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ReportCampaignsSpecific implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReportCampaignsSpecific';
    ...
    public function setListId($list_id)
    {
        ...
        if (($list_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $list_id when calling ReportCampaignsSpecific., must be bigger than or equal to 1.');
        }
     ...
     * Sets data
     *
     * @param string[] $data Array of campaign hashes
     *
     * @return $this
     */
