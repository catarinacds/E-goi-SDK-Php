 ...
 * @link     https://openapi-generator.tech
 */
class PushReport implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PushReport';
    ...
    public function setCampaignHash($campaign_hash)
    {
        ...
        if (!is_null($campaign_hash) && (!preg_match("/[a-zA-Z0-9_-]*/", $campaign_hash))) {
            throw new \InvalidArgumentException("invalid value for $campaign_hash when calling PushReport., must conform to the pattern /[a-zA-Z0-9_-]*/.");
        }
     ...
     *
     * @param object[]|null $operating_systems Stats of the campaign for each operating system
     *
     * @return $this
     */
     ...
     * Sets brands
     *
     * @param object[]|null $brands Stats of the campaign for each brand
     *
     * @return $this
     */
