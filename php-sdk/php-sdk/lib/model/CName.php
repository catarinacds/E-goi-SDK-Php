 ...
 * @link     https://openapi-generator.tech
 */
class CName implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CName';
    ...
    public function setCnameId($cname_id)
    {
        ...
        if (!is_null($cname_id) && ($cname_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $cname_id when calling CName., must be bigger than or equal to 1.');
        }
