...
/**
 * CampaignPushScheduleRequest Class Doc Comment
 *
 * @category Class
 * @package  org.egoi.client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class CampaignPushScheduleRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CampaignPushScheduleRequest';
    ...
    public function setAppId($app_id)
    {
        ...
        if (($app_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $app_id when calling CampaignPushScheduleRequest., must be bigger than or equal to 1.');
        }
