...
/**
 * AbstractCellphoneSender Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class AbstractCellphoneSender implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AbstractCellphoneSender';
    ...
    public function setSenderId($sender_id)
    {
        ...
        if (($sender_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $sender_id when calling AbstractCellphoneSender., must be bigger than or equal to 1.');
        }
