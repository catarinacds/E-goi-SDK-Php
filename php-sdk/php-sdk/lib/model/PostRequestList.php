...
/**
 * PostRequestList Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class PostRequestList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostRequestList';
     ...
     * Sets internal_name
     *
     * @param string $internal_name Internal name of the list
     *
     * @return $this
     */
     ...
     * Sets public_name
     *
     * @param string|null $public_name Public name of the list. Defaults to internal name if not set
     *
     * @return $this
     */
