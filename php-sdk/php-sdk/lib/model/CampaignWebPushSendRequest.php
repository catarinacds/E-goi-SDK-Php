...
/**
 * CampaignWebPushSendRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class CampaignWebPushSendRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CampaignWebPushSendRequest';
    ...
    public function setSiteId($site_id)
    {
        ...
        if (($site_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $site_id when calling CampaignWebPushSendRequest., must be bigger than or equal to 1.');
        }
