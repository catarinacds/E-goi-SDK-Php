...
/**
 * CampaignSmsOptions Class Doc Comment
 *
 * @category Class
 * @package  org.egoi.client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class CampaignSmsOptions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CampaignSmsOptions';
    ...
    public function setMaxMessages($max_messages)
    {
        ...
        if (!is_null($max_messages) && ($max_messages < 1)) {
            throw new \InvalidArgumentException('invalid value for $max_messages when calling CampaignSmsOptions., must be bigger than or equal to 1.');
        }
