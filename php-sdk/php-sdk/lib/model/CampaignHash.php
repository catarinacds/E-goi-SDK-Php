...
/**
 * CampaignHash Class Doc Comment
 *
 * @category Class
 * @package  org.egoi.client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class CampaignHash implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CampaignHash';
    ...
    public function setCampaignHash($campaign_hash)
    {
        ...
        if (!is_null($campaign_hash) && (!preg_match("/[a-zA-Z0-9_-]*/", $campaign_hash))) {
            throw new \InvalidArgumentException("invalid value for $campaign_hash when calling CampaignHash., must conform to the pattern /[a-zA-Z0-9_-]*/.");
        }
