...
/**
 * ContactExtraFieldCellphone Class Doc Comment
 *
 * @category Class
 * @package  org.egoi.client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ContactExtraFieldCellphone implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContactExtraFieldCellphone';
    ...
    public function setFieldId($field_id)
    {
        ...
        if (!is_null($field_id) && ($field_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $field_id when calling ContactExtraFieldCellphone., must be bigger than or equal to 1.');
        }
     ...
     * Sets value
     *
     * @param string|null $value Extra field value
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string|null $status Extra field status
     *
     * @return $this
     */
