...
/**
 * HashcodeCampaign Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class HashcodeCampaign implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HashcodeCampaign';
    ...
    public function setCampaignHash($campaign_hash)
    {
        ...
        if (!is_null($campaign_hash) && (!preg_match("/[a-zA-Z0-9_-]*/", $campaign_hash))) {
            throw new \InvalidArgumentException("invalid value for $campaign_hash when calling HashcodeCampaign., must conform to the pattern /[a-zA-Z0-9_-]*/.");
        }
