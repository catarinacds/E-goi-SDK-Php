...
class Tag implements ModelInterface, ArrayAccess
{
    ...
    public function setTagId($tag_id)
    {
        ...
        if (!is_null($tag_id) && ($tag_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $tag_id when calling Tag., must be bigger than or equal to 1.');
        }
     ...
     * Sets color
     *
     * @param string|null $color Main color of the tag
     *
     * @return $this
     */
