...
/**
 * OperationOperationData Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class OperationOperationData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Operation_operation_data';
     ...
     * Sets internal_name
     *
     * @param string|null $internal_name Internal name of the campaign (returns an empty string when not applicable)
     *
     * @return $this
     */
     ...
     * Sets campaign_hash
     *
     * @param string|null $campaign_hash Hash of the campaign (returns an empty string when not applicable)
     *
     * @return $this
     */
