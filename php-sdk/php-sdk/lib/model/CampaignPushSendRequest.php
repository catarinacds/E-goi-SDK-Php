...
/**
 * CampaignPushSendRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class CampaignPushSendRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CampaignPushSendRequest';
    ...
    public function setAppId($app_id)
    {
        ...
        if (($app_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $app_id when calling CampaignPushSendRequest., must be bigger than or equal to 1.');
        }
