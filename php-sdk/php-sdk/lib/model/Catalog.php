...
class Catalog implements ModelInterface, ArrayAccess
{
    ...
    public function setCatalogId($catalog_id)
    {
        ...
        if (!is_null($catalog_id) && ($catalog_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $catalog_id when calling Catalog., must be bigger than or equal to 1.');
        }
     ...
     * Sets title
     *
     * @param string|null $title Title of the catalog
     *
     * @return $this
     */
     ...
     * Sets language
     *
     * @param string|null $language Language of the catalog
     *
     * @return $this
     */
     ...
     * Sets currency
     *
     * @param string|null $currency Currency of the catalog
     *
     * @return $this
     */
