 ...
 * @link     https://openapi-generator.tech
 */
class BasicSender implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BasicSender';
    ...
    public function setSenderId($sender_id)
    {
        ...
        if (($sender_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $sender_id when calling BasicSender., must be bigger than or equal to 1.');
        }
