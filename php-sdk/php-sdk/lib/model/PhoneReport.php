 ...
 * @link     https://openapi-generator.tech
 */
class PhoneReport implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PhoneReport';
    ...
    protected static $openAPITypes = [
        ...
        'overall' => '\org.egoi.client\org.egoi.client.model\OverallOverall',
        'networks' => '\org.egoi.client\org.egoi.client.model\PhoneReportAllOfNetworks[]'
    ];
    ...
    public function setCampaignHash($campaign_hash)
    {
        ...
        if (!is_null($campaign_hash) && (!preg_match("/[a-zA-Z0-9_-]*/", $campaign_hash))) {
            throw new \InvalidArgumentException("invalid value for $campaign_hash when calling PhoneReport., must conform to the pattern /[a-zA-Z0-9_-]*/.");
        }
     ...
     * Gets overall
     *
     * @return \org.egoi.client\org.egoi.client.model\OverallOverall|null
     */
     ...
     * Sets overall
     *
     * @param \org.egoi.client\org.egoi.client.model\OverallOverall|null $overall overall
     *
     * @return $this
     */
     ...
     * Gets networks
     *
     * @return \org.egoi.client\org.egoi.client.model\PhoneReportAllOfNetworks[]|null
     */
     ...
     * Sets networks
     *
     * @param \org.egoi.client\org.egoi.client.model\PhoneReportAllOfNetworks[]|null $networks Stats of the campaign for each network
     *
     * @return $this
     */
