 ...
 * @link     https://openapi-generator.tech
 */
class ComplexContactAllOfWebpushStats implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['last_delivery_date'] = isset($data['last_delivery_date']) ? $data['last_delivery_date'] : null;
        $this->container['last_click_date'] = isset($data['last_click_date']) ? $data['last_click_date'] : null;
        $this->container['last_bounce_date'] = isset($data['last_bounce_date']) ? $data['last_bounce_date'] : null;
    }
