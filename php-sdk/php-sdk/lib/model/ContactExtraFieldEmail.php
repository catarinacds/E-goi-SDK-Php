...
/**
 * ContactExtraFieldEmail Class Doc Comment
 *
 * @category Class
 * @package  org.egoi.client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ContactExtraFieldEmail implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContactExtraFieldEmail';
    ...
    public function setFieldId($field_id)
    {
        ...
        if (!is_null($field_id) && ($field_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $field_id when calling ContactExtraFieldEmail., must be bigger than or equal to 1.');
        }
