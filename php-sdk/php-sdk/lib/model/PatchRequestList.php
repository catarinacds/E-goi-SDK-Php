...
/**
 * PatchRequestList Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class PatchRequestList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchRequestList';
     ...
     * Sets public_name
     *
     * @param string|null $public_name Public name of the list
     *
     * @return $this
     */
    ...
    public function setGroupId($group_id)
    {
        ...
        if (!is_null($group_id) && ($group_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $group_id when calling PatchRequestList., must be bigger than or equal to 1.');
        }
