 ...
 * @link     https://openapi-generator.tech
 */
class SendWebPush implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SendWebPush';
    ...
    public function setSiteId($site_id)
    {
        ...
        if (($site_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $site_id when calling SendWebPush., must be bigger than or equal to 1.');
        }
