...
class SmsCampaign implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SmsCampaign';
    ...
    protected static $openAPITypes = [
        ...
        'content' => '\org.egoi.client\org.egoi.client.model\CampaignSmsContent',
        'sender_id' => 'int',
    ...
    public function setListId($list_id)
    {
        ...
        if (($list_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $list_id when calling SmsCampaign., must be bigger than or equal to 1.');
        }
     ...
     * Sets internal_name
     *
     * @param string $internal_name SMS campaign internal name
     *
     * @return $this
     */
     ...
     * Gets content
     *
     * @return \org.egoi.client\org.egoi.client.model\CampaignSmsContent
     */
     ...
     * Sets content
     *
     * @param \org.egoi.client\org.egoi.client.model\CampaignSmsContent $content content
     *
     * @return $this
     */
    ...
    public function setSenderId($sender_id)
    {
        ...
        if (!is_null($sender_id) && ($sender_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $sender_id when calling SmsCampaign., must be bigger than or equal to 1.');
        }
