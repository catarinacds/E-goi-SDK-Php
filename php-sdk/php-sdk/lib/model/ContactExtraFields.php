...
/**
 * ContactExtraFields Class Doc Comment
 *
 * @category Class
 * @package  org.egoi.client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ContactExtraFields implements ModelInterface, ArrayAccess
{
    const DISCRIMINATOR = 'format';
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContactExtraFields';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['format'] = static::$openAPIModelName;
    }
    ...
    public function setFieldId($field_id)
    {
        ...
        if (!is_null($field_id) && ($field_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $field_id when calling ContactExtraFields., must be bigger than or equal to 1.');
        }
