...
/**
 * AdvancedReportCampaignsObject Class Doc Comment
 *
 * @category Class
 * @package  org.egoi.client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AdvancedReportCampaignsObject implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdvancedReportCampaignsObject';
    ...
    public function setListId($list_id)
    {
        ...
        if (($list_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $list_id when calling AdvancedReportCampaignsObject., must be bigger than or equal to 1.');
        }
     ...
     * Sets data
     *
     * @param int[] $data Array of campaign groups
     *
     * @return $this
     */
