...
/**
 * PushVersionsVersions Class Doc Comment
 *
 * @category Class
 * @package  org.egoi.client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class PushVersionsVersions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PushVersions_versions';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['canceled']) && ($this->container['canceled'] < 0)) {
            $invalidProperties[] = "invalid value for 'canceled', must be bigger than or equal to 0.";
        }
     ...
     * Sets version
     *
     * @param string|null $version Operating system version
     *
     * @return $this
     */
    ...
    public function setOpens($opens)
    {
        ...
        if (!is_null($opens) && ($opens < 0)) {
            throw new \InvalidArgumentException('invalid value for $opens when calling PushVersionsVersions., must be bigger than or equal to 0.');
        }
     ...
     * Sets canceled
     *
     * @param int|null $canceled Total number of delivered messages
     *
     * @return $this
     */
    public function setCanceled($canceled)
    {
        ...
        if (!is_null($canceled) && ($canceled < 0)) {
            throw new \InvalidArgumentException('invalid value for $canceled when calling PushVersionsVersions., must be bigger than or equal to 0.');
        }
    ...
    public function setDelivered($delivered)
    {
        ...
        if (!is_null($delivered) && ($delivered < 0)) {
            throw new \InvalidArgumentException('invalid value for $delivered when calling PushVersionsVersions., must be bigger than or equal to 0.');
        }
